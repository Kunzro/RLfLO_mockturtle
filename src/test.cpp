...
int main()
{
    Mockturtle_mig_api mtl;
    std::string lib_dir = "/home/kunzro/workspace/Reinforcement_Learning_for_Logic_Optimization/libraries/asap7.genlib";
    mtl.load_genlib(lib_dir);
    std::string verilog_dir = "/home/kunzro/workspace/Reinforcement_Learning_for_Logic_Optimization/circuits/sqrt.v";
    mtl.load_verilog(verilog_dir);
    std::cout << "rewrite duration: " << mtl.rewrite(false, false, false, 3u) << "\n";
    std::cout << "rewrite duration: " << mtl.rewrite(false, true, false, 3u) << "\n";
    std::cout << "rewrite duration: " << mtl.rewrite(false, false, true, 3u) << "\n";
    std::cout << "rewrite duration: " << mtl.rewrite(false, true, true, 3u) << "\n";
    mtl.map(lib_dir);
